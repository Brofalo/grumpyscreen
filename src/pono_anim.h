...
// Hawaii state flag, static opaque bitmaps. Generated by tools/gen_pono_flag.py.
// pono_flag: 192x96 (home top bar, zoomed). pono_flag_boot: 416x208 (the boot
// screen IS the flag, Jack 2026-06-11).
extern const lv_img_dsc_t pono_flag;
extern const uint16_t pono_flag_w;
extern const uint16_t pono_flag_h;
extern const lv_img_dsc_t pono_flag_boot;
